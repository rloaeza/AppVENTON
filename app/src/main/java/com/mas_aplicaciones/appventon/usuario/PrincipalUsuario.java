...
public class PrincipalUsuario extends Fragment {
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState)
    {
                ...
                ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED)
        {
            mapView.getMapAsync(mapboxMap -> {
                        ...
                        .withImage(ICON_ID, BitmapFactory.decodeResource(getActivity().getResources(), R.drawable.marker_40))

                        // Adding a GeoJson source for the SymbolLayer icons.
                        .withSource(new GeoJsonSource(SOURCE_ID, FeatureCollection.fromFeatures(FirebaseConexionFirestore.featuresUsuarios)))
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_principal_usuario, container, false);
        ImageButton btnMenu = view.findViewById(R.id.image_button_menu);
        btnMenu.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_principalUsuario_to_menuUsuario));
        return view;
    }
